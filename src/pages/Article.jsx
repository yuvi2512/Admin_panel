...
const Article = () => {
  ...
  const GetArticle = async () => {
    try {
      const response = await axios.get(
        "https://mamun-reza-freeshops-backend.vercel.app/api/v1/admin/Article/getArticle"
      );
  ...
  const handleDelete = async (row) => {
    try {
      const response = await axios.delete(`https://mamun-reza-freeshops-backend.vercel.app/api/v1/admin/Article/deleteArticle/${row?._id}`);
    ...
    try {
      if (isEditing) {
        ...
        const response = await axios.put(
          `https://mamun-reza-freeshops-backend.vercel.app/api/v1/admin/Article/updateArticle/${currentRowId}`,
          updateData,
          {
            headers: {
      ...
      toast.error(isEditing ? "Failed to update article." : "Failed to add article.");
    } finally {
      handleCloseModal();
    }
  };
