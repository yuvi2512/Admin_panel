...
const BlogCategory = () => {
  ...
  const handleDelete = async (row) => {
    try {
      const response = await axios.delete(`https://mamun-reza-freeshops-backend.vercel.app/api/v1/admin/BlogCategory/deleteBlogCategory/${row?._id}`);
    ...
    try {
      if (isEditing) {
        ...
        const response = await axios.put(
          `https://mamun-reza-freeshops-backend.vercel.app/api/v1/admin/BlogCategory/updateBlogCategory/${currentRowId}`,
          updateData,
          {
            headers: {
        ...
        const response = await axios.post(
          "https://mamun-reza-freeshops-backend.vercel.app/api/v1/admin/BlogCategory/addBlogCategory",
          formDataToSend,
          {
            headers: {
              "Content-Type": "application/json",
